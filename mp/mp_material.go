...
type WxMpMaterialService interface {
	...
	/* 分页获取其他媒体素材列表
	   详情请见: http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1444738734&token=&lang=zh_CN */
	MaterialFileBatchgetUrl(materialType MaterialType, offset, count int) (*WxMpMaterialFileBatchGetResult, error)
}
...
func (m *WxMpMaterialServiceImpl) MaterialFileBatchgetUrl(materialType MaterialType, offset, count int) (*WxMpMaterialFileBatchGetResult, error) {
	var data = map[string]interface{}{}
